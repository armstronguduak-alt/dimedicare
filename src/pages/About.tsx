    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-6">
            <div className="mx-auto max-w-5xl grid gap-12 md:grid-cols-2 md:items-center">
              <motion.div variants={fadeInLeft} initial="hidden" whileInView="visible" viewport={scrollViewport}>
                <div className="mb-4 inline-flex items-center rounded-full bg-primary/8 px-4 py-2 text-sm font-medium text-primary">
                  <Target className="mr-2 h-4 w-4" />
                  Our Mission
                </div>
                <h2 className="mb-6 font-serif text-4xl font-bold">Empowering Your Health Journey</h2>
              ...
              <motion.div variants={fadeInRight} initial="hidden" whileInView="visible" viewport={scrollViewport}>
                <div className="relative">
                  ...
                  <div className="relative rounded-2xl bg-card border border-border/50 p-8 shadow-lg">
                    <div className="h-14 w-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
                      <Award className="h-7 w-7 text-primary" />
                    </div>
                    <h3 className="mb-4 font-serif text-2xl font-bold">Trusted by Millions</h3>
                    <p className="text-muted-foreground leading-relaxed">
            ...
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={scrollViewport} className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {stats.map((stat) => (
                <motion.div key={stat.label} variants={staggerItem} className="text-center">
                  <div className="mb-2 font-serif text-4xl font-bold text-primary md:text-5xl">{stat.number}</div>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-6">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={scrollViewport} className="mb-12 text-center">
              <h2 className="mb-4 font-serif text-4xl font-bold">Our Core Values</h2>
              <p className="mx-auto max-w-2xl text-muted-foreground">These principles guide everything we do at Dimedicare</p>
            </motion.div>
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={scrollViewport} className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {values.map((value) => (
                <motion.div key={value.title} variants={staggerItem} whileHover={{ y: -6 }} className="group rounded-2xl border border-border/50 bg-card p-8 transition-shadow hover:shadow-lg">
                  <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/8 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground">
        ...
        <section className="py-20 bg-sage-100/20">
          <div className="container mx-auto px-6">
            <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={scrollViewport} className="mx-auto max-w-4xl text-center">
              <h2 className="mb-6 font-serif text-4xl font-bold">Our Expert Team</h2>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-6">
            <motion.div variants={scaleIn} initial="hidden" whileInView="visible" viewport={scrollViewport} className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-forest-700 to-forest-900 p-12 text-center text-primary-foreground md:p-16">
              <div className="absolute top-0 right-0 w-72 h-72 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl" />
              <div className="relative">
                <h2 className="mb-4 font-serif text-3xl font-bold md:text-4xl">Have Questions?</h2>
                <p className="mx-auto mb-8 max-w-2xl text-cream-200/70 text-lg">
                  We'd love to hear from you. Whether you have a question about our content, want to collaborate, or just want to say hello.
                </p>
                <motion.a href="/contact" whileHover={{ scale: 1.03, y: -1 }} whileTap={{ scale: 0.97 }} className="inline-flex items-center rounded-full bg-cream-100 px-8 py-3.5 text-sm font-semibold text-forest-800 hover:bg-white transition-colors shadow-lg">
                  Get in Touch
                </motion.a>
              </div>
            </motion.div>
